...
export const zh: Dictionary = {
    ...
    portfolio: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "VINNO 人體臨床便攜及推車式彩色多普勒超聲波 — A3、A5、VINNO 6、VINNO 8、VINNO 10、R300 及 R700 — 建基於 VLucid 平台並配備 AI 輔助工具。D6 VET 為專用獸醫型號。",
          href: "/brands/vinno",
          image: "/images/products/vinno-portfolio.jpg",
          imageFit: "contain",
          imageCaptionTitle: "VINNO 超聲波系列",
          imageCaptionSubtitle: "人體臨床 · D6 VET",
        },
      ],
    },
    whyChoose: {
    ...
    partners: {
      ...
      items: [
        ...
        },
        {
          ...
          image: "/images/products/vinno-portfolio.jpg",
          description:
            "創新超聲波技術，服務人體臨床 — 便攜及推車式彩色多普勒系統（A3、A5、VINNO 6、8、10、R300、R700），建基於 VLucid 平台並配備 AI 工具。D6 VET 專用於獸醫影像。",
        },
      ],
    },
    connect: {
  ...
  products: {
    ...
    vinnoFeaturedTitle: "VINNO 超聲波系統",
    vinnoFeaturedDesc:
      "人體臨床超聲波 — A3、A5、VINNO 6、VINNO 8、VINNO 10、R300 及 R700，建基於 VLucid 平台並配備 AI 輔助工具。D6 VET 為專用獸醫型號，僅用於動物護理。",
    vinnoCaptionTitle: "VINNO 超聲波系列",
    vinnoCaptionSubtitle: "人體臨床 · D6 VET",
    brandsLabel: "Brands",
    filterAll: "全部",
  ...
  about: {
    ...
    modalities: [
      ...
      "超聲波系統 — CHISON SonoEye 手持超聲波；VINNO 人體臨床系統（A3、A5、VINNO 6、VINNO 8、VINNO 10、R300、R700）及 D6 VET 獸醫超聲波",
  ...
  mini800Science: {
    button: "非侵入性肝纖維化診斷系統",
    teaserLabel: "科學原理",
    teaserTitle: "非侵入性肝纖維化診斷系統",
    teaserDesc:
      "瞬時彈性成像（TE）無需活檢即可定量肝硬度與脂肪變 — 採樣體積約 10 × 40 mm，至少為穿刺活檢樣本的 100 倍。",
    imageAlt:
      "示意圖：TE 探頭發出超聲波及剪切波，經皮膚及腹壁進入肝臟；圓柱形採樣體積約 10 mm × 40 mm，至少為活檢樣本的 100 倍",
    page: {
      title: "非侵入性肝纖維化診斷系統",
      subtitle: "振動控制瞬時彈性成像，用於肝纖維化及脂肪變的定量評估",
      intro:
        "iLivTouch Mini800 採用受控瞬時彈性成像（TE）— 與 HISKY FibroTouch 平台相同的科學原理 — 測量肝硬度（LSM，單位 kPa）及超聲衰減參數（UAP）。兩項生物標誌共同支援纖維化與脂肪變的非侵入性分期，有助慢性肝病的及早介入。",
      principlesLabel: "物理原理",
      principlesTitle: "瞬時彈性成像如何探測肝臟",
      principlesBody:
        "於體表產生受控低頻剪切波，使其在肝實質內傳播，再以高頻超聲波追蹤該波。剪切波速度隨組織硬度增加，經科學算法可得出肝硬度測量值（LSM，以千帕表示），用以評估纖維化程度。同時系統記錄超聲波在傳播過程中的能量衰減，得到超聲衰減參數（UAP），作為肝脂肪變的定量指標。",
      shearNote: "剪切波在組織中的傳播速度取決於該組織的硬度。",
      sampleTitle: "採樣幾何與活檢比較",
      sampleLead: "探測體積為直徑約 10 mm、長度約 40 mm 的圓柱。",
      sampleItems: [
        "採樣體積至少為典型肝活檢組織芯的 100 倍，可減少纖維化不均勻所致的取樣誤差。",
        "結果與組織學分期高度一致，同時保持非侵入及可重複。",
        "無需抽血；可進行系列檢查，支援治療監測與追蹤。",
      ],
      guidelinesTitle: "獲指引認可的技術",
      guidelinesIntro: "以瞬時彈性成像測量組織硬度，獲主要肝病學會廣泛引用：",
      guidelines: [
        "歐洲肝病學會（EASL）",
        "美國肝病研究學會（AASLD）",
        "亞太肝病學會（APASL）",
      ...
      outputsTitle: "單次檢查的定量輸出",
      outputs: [
        {
          title: "肝纖維化 — LSM（kPa）",
          description:
            "肝硬度與纖維化分期高度相關，涵蓋慢性乙型及丙型肝炎、酒精性肝病及非酒精性脂肪肝病（NAFLD）等主要病因。",
        },
        {
          title: "肝脂肪變 — UAP",
          description:
            "UAP 可將脂肪變分為正常、輕度、中度或重度，作為常規 B 型超聲波的客觀補充；後者在脂肪含量低於約 30% 時往往難以偵測。",
        },
        {
          title: "可選 B 型超聲導引",
          description:
            "Mini800 可選配超聲成像探頭，協助探頭定位並提供形態學背景，而 LSM 與 UAP 仍為檢查的定量核心。",
        },
      ],
      rationaleLabel: "臨床理據",
      rationaleTitle: "肝臟是沉默器官 — 纖維化是共同病理通路",
      quote: "任何人若能阻止或延緩肝纖維化，便能治癒大多數慢性肝病。",
      quoteBy: "肝病學奠基人 Hans Popper 博士",
      rationaleBody:
        "肝臟是人體代謝中樞，且沒有痛覺神經，因此即使損傷嚴重，臨床上亦可長期無症狀。纖維化是多種慢性肝病走向肝硬化、肝細胞癌及肝衰竭的共同組織病理過程。早中期纖維化普遍被視為可逆；及早診斷與治療可打斷此進程。",
      causesTitle: "導致纖維化的主要病因",
      causes: [
        "病毒性肝炎（HBV、HCV、HDV）",
        "酒精性肝病（ALD）",
        "非酒精性脂肪肝病（NAFLD）",
      ...
      reversible: [
        "臨床上公認早中期肝纖維化可逆。",
        "及早診斷與治療可預防進展至肝硬化、肝癌及肝衰竭。",
      ],
      traditionalTitle: "傳統診斷路徑的局限",
      traditionalIntro:
        "組織學仍是參考標準，但既有方法各有限制，因而需要快速、定量、非侵入的替代方案。",
      methods: [
        {
          name: "肝活檢",
          points: [
        ...
        },
        {
          name: "常規影像",
          points: [
            "超聲波：僅提供形態學；多見晚期纖維化；脂肪變低於約 30% 時往往未能發現",
            "CT：電離輻射且費用較高",
            "MRI：費用高、檢查時間較長",
          ],
        },
      ],
      advantagesTitle: "基於 TE 評估的臨床優勢",
      advantages: [
        {
          title: "非侵入且可重複",
          description: "無需抽血。適合纖維化與脂肪變的長期追蹤，以及治療反應評估。",
        },
        {
          title: "雙重生物標誌同步取得",
          description: "一次檢查同時獲得纖維化（LSM）與脂肪變（UAP），結果可存檔作同一患者跨時間比較。",
        },
        {
          title: "快速定量讀數",
          description: "完整檢查通常只需數分鐘，硬度與衰減參數即時報告。",
        },
        {
          title: "更大、更具代表性的採樣",
          description: "約 10 × 40 mm 圓柱體積至少為活檢組織芯的 100 倍，與組織學結果高度一致。",
        },
      ],
      departmentsTitle: "適用臨床場景",
      departmentsIntro: "定量 TE 既可用於高危人群個案發現，亦可用於已確診肝病的系列監測。",
      departments: [
        "內科 — 肝病科",
        "消化科",
        "感染科",
