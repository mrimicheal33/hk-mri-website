...
export const zh: Dictionary = {
  ...
  about: {
    ...
    brandsModalitiesIntro:
      "我們代理 CHISON、HISKY、MINDRAY、UNITED IMAGING、PERLOVE 及 VETOO，提供由床邊超聲波、肝纖維化評估、數位放射影像、乳腺攝影、MRI、CT、PET-CT 至獸醫影像的全線醫學影像及診斷解決方案，涵蓋：",
    modalities: [
      "CT（電腦斷層掃描）— UNITED IMAGING uCT 780 128 層及 uCT 960+ 640 層 CT",
      "診斷檢測 — HISKY iLivTouch Mini800 便攜式肝纖維化及脂肪定量分析",
      "數位放射影像 (DR) — MINDRAY DigiEye 及 MobiEye 移動 DR、UNITED IMAGING uDR 596i 落地式 DR",
      "肝纖維化掃描儀 — MINDRAY Hepatus 系列非侵入性肝纖維化及脂肪肝評估",
      "乳腺攝影 — UNITED IMAGING uMammo 890i 低劑量 3D 數位乳腺攝影",
      ...
      "獸醫影像 — PERLOVE VET1120 移動式數位 C-arm 及 VETOO VF1 Dynamic DR",
    ],
    brandsTitle: "代理品牌",
