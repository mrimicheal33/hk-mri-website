export const en = {
  ...
  common: {
    ...
    whatsappInstant: "WhatsApp Instant Chat",
    exploreSonoeye: "Explore SonoEye",
    featured: "Featured",
    featuredProduct: "Featured Product",
    exclusiveAgent: "HK & Macau Exclusive Agent",
  ...
  categories: {
    ...
    diagnostic: "Portable Shear-wave Elastography",
    veterinary: "Veterinary Imaging",
    "veterinary-carm": "Veterinary Mobile Digital C-arm System",
  },
  company: {
      ...
      items: [
        ...
        },
        {
          ...
          recommendedProducts: [
            ...
            {
              name: "VINNO D6 VET Compact Veterinary Ultrasound",
              brand: "VINNO",
    ...
    portfolio: {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "VINNO portable and cart-based colour Doppler ultrasound for human clinical care — A3, A5, VINNO 6, VINNO 8, VINNO 10, R300 and R700 — on VLucid platforms with AI-assisted tools. D6 VET is a dedicated veterinary model.",
          href: "/brands/vinno",
          image: "/images/products/vinno-portfolio.jpg",
          imageFit: "contain",
          imageCaptionTitle: "VINNO Ultrasound Family",
          imageCaptionSubtitle: "Human Clinical · D6 VET",
        },
      ],
    },
    whyChoose: {
    ...
    partners: {
      ...
      items: [
        ...
        },
        {
          ...
          image: "/images/products/vinno-portfolio.jpg",
          description:
            "Innovative ultrasound for human clinical care — portable and cart-based colour Doppler systems (A3, A5, VINNO 6, 8, 10, R300, R700) on VLucid platforms with AI tools. D6 VET is dedicated to veterinary imaging.",
        },
      ],
    },
    connect: {
  ...
  products: {
    ...
    vinnoFeaturedTitle: "VINNO Ultrasound Systems",
    vinnoFeaturedDesc:
      "Human clinical ultrasound — A3, A5, VINNO 6, VINNO 8, VINNO 10, R300 and R700 on VLucid platforms with AI-assisted tools. D6 VET is a dedicated veterinary model for animal care.",
    vinnoCaptionTitle: "VINNO Ultrasound Family",
    vinnoCaptionSubtitle: "Human Clinical · D6 VET",
    brandsLabel: "Brands",
    filterAll: "All",
  ...
  about: {
    ...
    modalities: [
      ...
      "Ultrasound Systems — CHISON SonoEye handheld ultrasound; VINNO human clinical systems (A3, A5, VINNO 6, VINNO 8, VINNO 10, R300, R700) plus D6 VET veterinary ultrasound",
    ...
    values: [
      {
        ...
        description: "Representing global medical brands with quality products and technical support.",
      },
      {
  ...
  contact: {
    ...
    nameLabel: "Name / Organisation",
    namePlaceholder: "Your name or organisation",
    emailLabel: "Email",
    phoneLabel: "Phone",
    productLabel: "Products of Interest",
    quoteColBrandProduct: "Product",
    quoteColModel: "Model",
    quoteColSelect: "Select",
    quoteMultiHint:
      "Select all products you would like quoted. You can choose more than one.",
  ...
  footer: {
    ...
    contact: "Contact",
    productOverview: "Product Catalogue",
  },
  sonoeye: {
    subtitle: "Handheld Ultrasound Diagnostic System",
    features: {
      label: "Features",
      title: "Handheld Ultrasound Built for Modern Practice",
      description:
        "Combining portability, professional imaging, and AI intelligence for every clinician.",
      items: [
        {
          title: "Pocket-Sized Portability",
          description:
            "Phone-sized ultrasound probe that fits in a white coat pocket for point-of-care scanning anywhere.",
        },
        {
          title: "Go Thumb-Play",
          description:
        ...
        },
        {
          ...
          description:
            "IP67 waterproof and dustproof with MIL-STD-810G drop testing for demanding clinical environments.",
        },
        {
          title: "AI-Assisted Imaging",
          description:
            "Built-in SonoMSK musculoskeletal and SonoDiaph lung analysis to lower the learning curve.",
        },
      ],
    },
    applications: {
      label: "Applications",
      title: "Multi-Specialty Clinical Scenarios",
      description: "Tailored clinical solutions for every specialty.",
      items: [
        { title: "ICU / Emergency", items: ["Pleural effusion", "Cardiac function", "Vascular access"] },
        { title: "General Practice", items: ["Abdominal screening", "Carotid screening", "Thyroid exam"] },
        { title: "Aesthetics / Injection", items: ["Injection guidance", "Filler placement", "Vessel avoidance"] },
        { title: "Chiropractic / MSK", items: ["Joint ultrasound", "Tendon assessment", "Guided injection"] },
      ],
    },
    specs: {
      ...
      items: [
        ...
        { label: "AI Features", value: "SonoMSK, SonoDiaph" },
        { label: "Territory", value: "Hong Kong, Macau" },
      ],
    },
    training: {
      label: "Training",
      title: "Course-Led Sales",
      description:
        "Hands-on workshops let physicians experience SonoEye ease-of-use and clinical value. Course fees are fully deductible against purchase.",
      steps: [
        "Targeted Facebook / Instagram / LinkedIn advertising",
        "Landing page lead capture",
        "Hands-on workshop — 80% practical training",
        "On-site purchase — course fee fully credited",
      ],
    },
    cta: {
