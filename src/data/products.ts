...
export const products: Product[] = [
  ...
  },
  {
    id: "vinno6",
    name: "VINNO 6",
    nameEn: "Ultra-Portable Colour Doppler Ultrasound",
    brand: "VINNO",
    brandSlug: "vinno",
    category: "ultrasound",
    ...
    brochure: "/brochures/vinno6-brochure.pdf",
  },
  {
    id: "vinno8",
    name: "VINNO 8",
    nameEn: "Premium Portable Colour Doppler Ultrasound",
    brand: "VINNO",
    brandSlug: "vinno",
    category: "ultrasound",
    tagline: "Groundbreaking Design. Powerful Capabilities.",
    description:
      "VINNO 8 為高端便攜彩色多普勒超聲波系統 — 結合 Zone Imaging、智能工作流程及輕巧設計，支援進階婦產、心臟及一般影像應用，適合診所與醫院多場景診斷。",
    highlights: [],
    featured: true,
    image: "/images/products/vinno8-card.jpg",
    brochure: "/brochures/vinno8-brochure.pdf",
  },
  {
    id: "vinno10",
    name: "VINNO 10",
    ...
    highlights: [],
    featured: true,
    image: "/images/products/vinno10-card.jpg",
    brochure: "/brochures/vinno10-brochure.pdf",
  },
  {
    id: "vinno-a5",
    name: "VINNO A5",
    nameEn: "Portable Colour Doppler Ultrasound",
    brand: "VINNO",
    brandSlug: "vinno",
    category: "ultrasound",
    tagline: "Deliver Simplified Clinical Solution Anywhere",
    description:
      "VINNO A5 為便攜彩色多普勒超聲波系統 — 以緊湊設計、簡化工作流程及高影像質素，結合可調高度推車、快速開機及內置電池，適合一般影像、婦產、肌骨及多場景臨床應用。",
    highlights: [],
    featured: true,
    image: "/images/products/vinno-a5-card.jpg",
    brochure: "/brochures/vinno-a5-brochure.pdf",
  },
  {
    id: "vinno-r300",
    name: "VINNO R300",
    nameEn: "Cart-Based Colour Doppler Ultrasound",
    brand: "VINNO",
    brandSlug: "vinno",
    category: "ultrasound",
    tagline: "Excellence within Reach",
    description:
      "VINNO R300 為推車式彩色多普勒超聲波系統 — 搭載 VLucid+ 平台及 UltraSense AI 方案，提供高效精準成像，適用於一般影像、甲狀腺、乳腺、心臟及婦產等多專科臨床需求。",
    highlights: [],
    featured: true,
    image: "/images/products/vinno-r300-card.jpg",
    brochure: "/brochures/vinno-r300-brochure.pdf",
  },
  {
    id: "vinno-r700",
    name: "VINNO R700",
    nameEn: "Shared-Service Cart-Based Ultrasound",
    brand: "VINNO",
    brandSlug: "vinno",
    category: "ultrasound",
    tagline: "Elevating Ultrasound Efficiency with Lucid Vision",
    description:
      "VINNO R700 為高效共享服務推車式超聲波系統 — 搭載 VLucid+ 平台、23.8 吋大顯示屏、可調操控台及多探頭接口，結合 RAD、DSE 及 DVP 等進階成像技術，提升多專科掃描效率與影像清晰度。",
    highlights: [],
    featured: true,
    image: "/images/products/vinno-r700-card.jpg",
    brochure: "/brochures/vinno-r700-brochure.pdf",
  },
  {
    id: "vinno-d6-vet",
    name: "VINNO D6 VET",
    nameEn: "High-End Compact Veterinary Colour Doppler Ultrasound",
    brand: "VINNO",
    brandSlug: "vinno",
    category: "veterinary",
    tagline: "Excellent Performance and Advanced Experience for Animals",
    description:
      "VINNO D6 VET 為高端緊湊獸醫彩色多普勒超聲波系統 — 建基於 VLucid+ 平台，配備獸醫專用心臟定量（vCQ）、VGuide 針道導引及應變成像等工具，適合診所、醫院及外勤動物護理場景。",
    highlights: [],
    featured: true,
    image: "/images/products/vinno-d6-vet-card.jpg",
    brochure: "/brochures/vinno-d6-vet-brochure.pdf",
  },
  // PERLOVE
  {
    id: "vet1120",
